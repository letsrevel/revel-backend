...
class TestValidateAndUpdateBillingProfile:
    ...
    def test_valid_result_updates_fields(self, mock_post: MagicMock, profile_with_vat: UserBillingProfile) -> None:
        ...
        mock_post.return_value = mock_vies_response(valid=True, request_identifier="REQ789")
    ...
    def test_valid_result_auto_fills_billing_address(
        ...
        mock_post.return_value = mock_vies_response(valid=True, address="VIA ROMA 1, 00100 ROMA RM")
    ...
    def test_valid_result_does_not_overwrite_existing_address(
        ...
        mock_post.return_value = mock_vies_response(valid=True, address="VIA ROMA 1")
    ...
    def test_invalid_result_does_not_fill_fields(
        ...
        mock_post.return_value = mock_vies_response(valid=False, name="ACME", address="Some Address")
