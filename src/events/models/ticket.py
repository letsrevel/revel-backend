...
# Payment now lives in .payment (file-length limit); re-exported here since most call sites
# still do `from events.models.ticket import Payment`.
from .payment import Payment as Payment  # noqa: E402, F401
