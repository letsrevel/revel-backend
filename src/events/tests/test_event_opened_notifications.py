...
class TestEventOpenedNotification:
    ...
    def test_event_opened_notification_sends_on_status_update(
        ...
        with patch("events.service.event_notification_service.notification_requested.send") as mock_send:
            ...
            assert call_args.kwargs["notification_type"] == NotificationType.EVENT_OPEN
            assert call_args.kwargs["user"] == nonmember_user
