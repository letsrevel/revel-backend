...
class TestSubscriptionWebhookDispatch:
    ...
    @patch("events.service.subscription.stripe.sync.sync_subscription_from_stripe")
    ...
    @patch("events.service.subscription.stripe.sync.record_stripe_payment_from_invoice")
