...
from events.service.stripe_webhook_refunds import TicketRefundHandlersMixin
...
class StripeEventHandler(SubscriptionWebhookHandlersMixin, TicketRefundHandlersMixin):
