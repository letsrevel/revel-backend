...
def test_configured_when_both_settings_set(google_wallet_configured_settings: None) -> None:
    assert google_wallet_configured() is True


def test_not_configured_when_unset(google_wallet_not_configured: None) -> None:
...
def test_ticket_google_pass_available(google_wallet_configured_settings: None, ticket: t.Any) -> None:
    assert ticket.google_pass_available is True


@pytest.mark.django_db
def test_ticket_google_pass_unavailable(google_wallet_not_configured: None, ticket: t.Any) -> None:
